...
const Notifications = ({ navigation }) => {
  ...
  const renderNotificationItem = (item) => (
    <TouchableOpacity key={item.id} style={currentStyles.notificationItem}>
      <View style={currentStyles.notificationContent}>
        <Text style={currentStyles.notificationTitle}>{item.title}</Text>
        <Text style={currentStyles.notificationDescription}>{item.description}</Text>
      </View>
      <Text style={currentStyles.notificationTime}>{item.time}</Text>
    </TouchableOpacity>
  );
