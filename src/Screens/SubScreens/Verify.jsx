    ...
    <SafeAreaView style={currentStyles.container}>
      ...
      <View style={currentStyles.header}>
        <TouchableOpacity style={currentStyles.backButton} onPress={handleGoBack}>
          <View style={currentStyles.backButtonCircle}>
            <Icon name="arrow-back" size={isTablet ? 24 : 20} color="#333" />
          </View>
        </TouchableOpacity>
        <Text style={currentStyles.headerTitle}>Verify</Text>
        <View style={currentStyles.headerRight} />
      </View>

      {/* Content */}
      <View style={currentStyles.content}>
        <Text style={currentStyles.title}>OTP code verification</Text>
        ...
        <View style={currentStyles.otpContainer}>
          {otp.map((digit, index) => (
            <TextInput
              ...
              ref={inputRefs[index]}
              style={[
                currentStyles.otpInput,
                digit ? currentStyles.otpInputFilled : currentStyles.otpInputEmpty
              ]}
              value={digit}
              onChangeText={(value) => handleOtpChange(value.replace(/[^0-9]/g, ''), index)}
              onKeyPress={(e) => handleKeyPress(e, index)}
        ...
        {/* Resend Section */}
        <View style={currentStyles.resendSection}>
          <Text style={currentStyles.resendText}>Didn't receive code?</Text>
          <TouchableOpacity 
            onPress={handleResendCode} 
            disabled={isTimerActive}
          ...
          >
            <Text style={[
              currentStyles.resendButtonText,
              isTimerActive ? currentStyles.resendDisabled : currentStyles.resendEnabled
            ]}>
              You can resend code in {formatTimer(timer)}
            </Text>
          </TouchableOpacity>
